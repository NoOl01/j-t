...
func Connect() *gorm.DB {
	...
	if migrateErr := db.AutoMigrate(&models.Category{}, &models.Product{}, &models.User{}, &models.Cart{}, &models.CartItem{}, &models.Points{}, &models.OrderItem{}, &models.Order{}); migrateErr != nil {
		panic(err)
	}
